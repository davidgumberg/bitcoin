...
public:
    ...
    static std::shared_ptr<CWallet> CreateNew(WalletContext& context, const std::string& name, std::unique_ptr<WalletDatabase> database, uint64_t wallet_creation_flags, bool create_blank, bilingual_str& error, std::vector<bilingual_str>& warnings);
