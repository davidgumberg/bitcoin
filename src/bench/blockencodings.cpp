...
static void BlockEncodingMaybeEarlyExit(benchmark::Bench& bench)
{
    BlockEncodingBench(bench, /*n_pool=*/50'000, /*n_extra*/100, /*n_random_in_block=*/0, /*n_pool_in_block=*/7'000, /*n_extra_in_block=*/10);
}

static void BlockEncodingMaybeEarlyExitOneExtra(benchmark::Bench& bench)
{
    BlockEncodingBench(bench, /*n_pool=*/50'000, /*n_extra*/100, /*n_random_in_block=*/0, /*n_pool_in_block=*/7'000, /*n_extra_in_block=*/1);
}

static void BlockEncodingMaybeEarlyExitNoExtra(benchmark::Bench& bench)
{
...
BENCHMARK(BlockEncodingMaybeEarlyExit, benchmark::PriorityLevel::HIGH);
BENCHMARK(BlockEncodingMaybeEarlyExitOneExtra, benchmark::PriorityLevel::HIGH);
BENCHMARK(BlockEncodingMaybeEarlyExitNoExtra, benchmark::PriorityLevel::HIGH);
