...
BOOST_AUTO_TEST_CASE(tcp_info)
{
    ...
    socket_pair socks = socket_pair::create(/*connect=*/false);

    // Set very small and random receiver advertised window, as long as we are
    // below MSS this will be the window size.
