...
'ADVAPI32.dll', # deprecated security & registry API
'bcrypt.dll', # newer security & identity API
...
if __name__ == '__main__':
    ...
    for filename in sys.argv[1:]:
        ...
        if binary is None:
            print(f"{filename}: failed, is not a binary.")
            retval = 1
            break
        else:
            binary = cast(lief.Binary, binary)
